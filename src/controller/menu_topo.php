...
<nav class="navbar navbar-center navbar-expand-lg navbar-dark bg-dark text-center header darkTheme">
    ...
    <div class="collapse navbar-collapse menuContainer" id="navbarSupportedContent">
      ...
      <ul class="navbar-nav navbar-center myMenu">
        <li class="nav-item mr-4">
          <a class="navbar-brand logoContainer text-left text-md-left text-lg-center" href="<?php if ($pageName=='index'){ echo '#'; }else{ echo '../../';} ?>">
      ...
      <ul class="navbar-nav navbar-right myMenu">
        <li class="nav-item mr-4">
