...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark text-center header darkTheme">
    <a class="navbar-brand logoContainer" href="<?php if ($pageName=='index'){ echo '#'; }else{ echo '../../';} ?>">
    ...
    <div class="collapse navbar-collapse menuContainer" id="navbarSupportedContent">
      <ul class="navbar-nav myMenu">
        ...
        <li class="nav-item">
          <a class="nav-link myAccountButton <?php if ($pageName=='login'){ echo 'activeHeader'; }?>" href="<?php if ($pageName=='login'){ echo '#'; }else{ echo '../../login';} ?>" style="color: #009DBE;">Minha Conta <i
