    ...
    $.get(url_geral + "perfil-profissional-land", { id_user: $.urlParam('id_user') }, function (result) {
      ...
      $("#searchDetail").html('<div class="card text-center">' +
        '<div id="img_perfil_detail' + result.result.perfil[i].id_user + '" class="card-header"></div>' +
          '<div class="card-body">' +
          '<h5 class="card-title myTitle">' + result.result.perfil[i].nome + '</h5>' +
            '<p style="text-align: center; margin: 5px;">' +
            ...
            '</p>' +
          '<p class="card-text mt-2"><b>Telefone:</b> (' + result.result.perfil[i].area + ') ' + result.result.perfil[i].telefone + '</p>' +
          '<p class="card-text"><b>Observação:</b> ' + result.result.perfil[i].obs + '</p>' +
          '<p class="card-text"><b>Aceita Cartão:</b> ' + aceita_cartao + '</p>' +
          '<p class="card-text"><b>Cobra Visita?</b> ' + cobra_visita + '</p>' +
          '<p class="card-text"><b>Emite Nota?</b> ' + mei + '</p>' +
          '</div>' + 
        '</div>');
